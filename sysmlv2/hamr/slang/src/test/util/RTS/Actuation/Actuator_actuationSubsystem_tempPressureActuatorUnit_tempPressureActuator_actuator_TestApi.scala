...
@msig trait Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_TestApi {
  ...
  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator)
  }
  ...
  def put_ports_input(value : Base_Types.Boolean): Unit = {
    Art.insertInInfrastructurePort(Arch.rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.operational_api.ports_input_Id, Base_Types.Boolean_Payload(value))
  }

  // setter for in DataPort
  def put_ports_manualActuatorInput(value : Base_Types.Boolean): Unit = {
    Art.insertInInfrastructurePort(Arch.rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.operational_api.ports_manualActuatorInput_Id, Base_Types.Boolean_Payload(value))
  }
  ...
  def get_ports_output_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.initialization_api.ports_output_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }

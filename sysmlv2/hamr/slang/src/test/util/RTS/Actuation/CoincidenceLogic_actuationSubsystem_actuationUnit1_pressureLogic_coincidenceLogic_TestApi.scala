...
@msig trait CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_TestApi {
  ...
  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic)
  }
  ...
  def get_ports_actuate_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.initialization_api.ports_actuate_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }

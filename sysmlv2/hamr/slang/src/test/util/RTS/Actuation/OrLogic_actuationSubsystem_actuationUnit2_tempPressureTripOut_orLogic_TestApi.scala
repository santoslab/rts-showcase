...
@msig trait OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_TestApi {
  ...
  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }
  ...
  def get_ports_actuate_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic.initialization_api.ports_actuate_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }

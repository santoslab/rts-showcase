...
@sig trait CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_PreState_Container extends Container {
  def api_channel1: B
  def api_channel2: B
  def api_channel3: B
  def api_channel4: B
...
@sig trait CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_PostState_Container extends Container {
  def api_actuate: B
}

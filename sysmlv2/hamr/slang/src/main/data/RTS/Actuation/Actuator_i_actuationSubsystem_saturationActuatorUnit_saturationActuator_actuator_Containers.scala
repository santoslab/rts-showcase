...
@sig trait Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_PreState_Container extends Container {
  def api_input: B
...
@sig trait Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_PostState_Container extends Container {
  def api_output: B
}

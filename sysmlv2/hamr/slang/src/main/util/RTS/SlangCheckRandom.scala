...
@msig trait RandomLibI {
  ...
  def nextutilContainer(): util.Container = {
    ...
    var v: util.Container = c match {
      ...
      case utilContainer_DataTypeId.ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_P_Id => (nextActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_PS_Id => (nextActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_P_Id => (nextActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_PS_Id => (nextActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_PS _).apply()
      case utilContainer_DataTypeId.EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_P_Id => (nextEventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_PS_Id => (nextEventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_P_Id => (nextEventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_PS_Id => (nextEventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_PS _).apply()
      case utilContainer_DataTypeId.InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container_P_Id => (nextInstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container_PS_Id => (nextInstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_P_Id => (nextInstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_PS_Id => (nextInstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_PS _).apply()

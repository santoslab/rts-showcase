...
B art_Connection__equiv(art_Connection this, art_Connection other) {
  if (art_UPort__inequiv((art_UPort) &this->from, (art_UPort) &other->from)) return F;
  if (art_UPort__inequiv((art_UPort) &this->to, (art_UPort) &other->to)) return F;
  return T;
}

B art_Connection__ne(art_Connection this, art_Connection other);
B art_Connection__inequiv(art_Connection this, art_Connection other);

...
B art_DispatchPropertyProtocol_Sporadic__equiv(art_DispatchPropertyProtocol_Sporadic this, art_DispatchPropertyProtocol_Sporadic other);
inline B art_DispatchPropertyProtocol_Sporadic__inequiv(art_DispatchPropertyProtocol_Sporadic this, art_DispatchPropertyProtocol_Sporadic other) {
  return !art_DispatchPropertyProtocol_Sporadic__equiv(this, other);
};

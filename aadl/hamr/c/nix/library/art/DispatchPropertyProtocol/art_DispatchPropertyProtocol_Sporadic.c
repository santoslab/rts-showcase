...
B art_DispatchPropertyProtocol_Sporadic__equiv(art_DispatchPropertyProtocol_Sporadic this, art_DispatchPropertyProtocol_Sporadic other) {
  if (Z__inequiv(this->min, other->min)) return F;
  return T;
}
...
B art_DispatchPropertyProtocol_Sporadic__inequiv(art_DispatchPropertyProtocol_Sporadic this, art_DispatchPropertyProtocol_Sporadic other);

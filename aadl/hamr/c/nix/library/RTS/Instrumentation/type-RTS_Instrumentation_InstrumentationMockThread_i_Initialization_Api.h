#ifndef SIREUM_TYPE_H_RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api
#define SIREUM_TYPE_H_RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api
...
typedef struct RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api *RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api;
struct RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api {
  TYPE type;
  art_Art_BridgeId id;
...
#define DeclNewRTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api(x) struct RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api x = { .type = TRTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api }

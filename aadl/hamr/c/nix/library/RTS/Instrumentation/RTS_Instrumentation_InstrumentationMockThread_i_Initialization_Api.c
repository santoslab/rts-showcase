...
B RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api__eq(RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api this, RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api other) {
...
B RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api__equiv(RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api this, RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api other) {
...
B RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api__ne(RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api this, RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api other);
B RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api__inequiv(RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api this, RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api other);

void RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api_string_(STACK_FRAME String result, RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api this) {
  DeclNewStackFrame(caller, "InstrumentationMockThread_i_Api.scala", "RTS.Instrumentation.InstrumentationMockThread_i_Initialization_Api", "string", 0);
  String_string_(SF result, string("InstrumentationMockThread_i_Initialization_Api("));
  String sep = string(", ");
...
void RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api_cprint(RTS_Instrumentation_InstrumentationMockThread_i_Initialization_Api this, B isOut) {
  #ifndef SIREUM_NO_PRINT
  void *sf = NULL;
  String_cprint(string("InstrumentationMockThread_i_Initialization_Api("), isOut);
  String sep = string(", ");

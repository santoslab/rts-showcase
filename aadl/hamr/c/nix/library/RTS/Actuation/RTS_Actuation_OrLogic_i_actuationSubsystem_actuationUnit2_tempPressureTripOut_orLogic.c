...
Unit RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_initialise(STACK_FRAME RTS_Actuation_OrLogic_i_Initialization_Api api) {
  DeclNewStackFrame(caller, "OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic.scala", "RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic", "initialise", 0);
...
Unit RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_finalise(STACK_FRAME RTS_Actuation_OrLogic_i_Operational_Api api) {
  DeclNewStackFrame(caller, "OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic.scala", "RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic", "finalise", 0);
}
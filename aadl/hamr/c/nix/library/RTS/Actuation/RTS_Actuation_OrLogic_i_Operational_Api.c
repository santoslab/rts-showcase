...
inline B RTS_Actuation_OrLogic_i_Operational_Api_get_channel1_extract_69_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, RTS_Actuation_OrLogic_i_Operational_Api this, B *_v_69_44) {
...
inline B RTS_Actuation_OrLogic_i_Operational_Api_get_channel1_extract_70_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, RTS_Actuation_OrLogic_i_Operational_Api this, art_DataContent *_v_70_17) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_v_70_17 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

inline B RTS_Actuation_OrLogic_i_Operational_Api_get_channel1_extract_73_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, RTS_Actuation_OrLogic_i_Operational_Api this) {
  return T;
}
...
void RTS_Actuation_OrLogic_i_Operational_Api_get_channel1_(STACK_FRAME Option_8F4D4C result, RTS_Actuation_OrLogic_i_Operational_Api this) {
  ...
  if (!match_68_46) {
    B v_69_44;
    match_68_46 = RTS_Actuation_OrLogic_i_Operational_Api_get_channel1_extract_69_12_8E9F45(SF t_0, this, &v_69_44);
    if (match_68_46) {
  ...
  if (!match_68_46) {
    ...
    match_68_46 = RTS_Actuation_OrLogic_i_Operational_Api_get_channel1_extract_70_12_8E9F45(SF t_0, this, &v_70_17);
    if (match_68_46) {
  ...
  if (!match_68_46) {
    match_68_46 = RTS_Actuation_OrLogic_i_Operational_Api_get_channel1_extract_73_12_8E9F45(SF t_0, this);
    if (match_68_46) {
...
inline B RTS_Actuation_OrLogic_i_Operational_Api_get_channel2_extract_88_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, RTS_Actuation_OrLogic_i_Operational_Api this, B *_v_88_44) {
  if (!Some_D29615__is(SF t_0)) return F;
  if (!RTS_Base_Types_Boolean_Payload__is(SF Some_D29615_value_(Some_D29615__as(SF t_0)))) return F;
...
inline B RTS_Actuation_OrLogic_i_Operational_Api_get_channel2_extract_89_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, RTS_Actuation_OrLogic_i_Operational_Api this, art_DataContent *_v_89_17) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_v_89_17 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

inline B RTS_Actuation_OrLogic_i_Operational_Api_get_channel2_extract_92_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, RTS_Actuation_OrLogic_i_Operational_Api this) {
  return T;
}
...
void RTS_Actuation_OrLogic_i_Operational_Api_get_channel2_(STACK_FRAME Option_8F4D4C result, RTS_Actuation_OrLogic_i_Operational_Api this) {
  ...
  if (!match_87_46) {
    B v_88_44;
    match_87_46 = RTS_Actuation_OrLogic_i_Operational_Api_get_channel2_extract_88_12_8E9F45(SF t_0, this, &v_88_44);
    if (match_87_46) {
      DeclNewSome_DB59FB(t_2);
  ...
  if (!match_87_46) {
    ...
    match_87_46 = RTS_Actuation_OrLogic_i_Operational_Api_get_channel2_extract_89_12_8E9F45(SF t_0, this, &v_89_17);
    if (match_87_46) {
  ...
  if (!match_87_46) {
    match_87_46 = RTS_Actuation_OrLogic_i_Operational_Api_get_channel2_extract_92_12_8E9F45(SF t_0, this);
    if (match_87_46) {
      DeclNewNone_7E20F8(t_5);
      None_7E20F8_apply(SF &t_5);
      value = (Option_8F4D4C) (&t_5);

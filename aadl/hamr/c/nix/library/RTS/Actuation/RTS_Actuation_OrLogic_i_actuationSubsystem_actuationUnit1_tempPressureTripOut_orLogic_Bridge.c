...
B RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_initialized_ = F;

union Option_1C3ADA _RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_initialization_api;
union Option_E142FF _RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_operational_api;

void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init(STACK_FRAME_ONLY) {
  if (RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_initialized_) return;
  RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_initialized_ = T;
  DeclNewStackFrame(caller, "OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge.scala", "RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge", "<init>", 0);
  RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init_c_initialization_api(SF_LAST);
  RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init_c_operational_api(SF_LAST);
}
...
Option_1C3ADA RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_initialization_api(STACK_FRAME_ONLY) {
  RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init(CALLER_LAST);
  return (Option_1C3ADA) &_RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_initialization_api;
}
...
void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_initialization_api_a(STACK_FRAME Option_1C3ADA p_c_initialization_api) {
  RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init(CALLER_LAST);
  Type_assign(&_RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_initialization_api, p_c_initialization_api, sizeof(union Option_1C3ADA));
}
...
Option_E142FF RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_operational_api(STACK_FRAME_ONLY) {
  RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init(CALLER_LAST);
  return (Option_E142FF) &_RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_operational_api;
}
...
void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_operational_api_a(STACK_FRAME Option_E142FF p_c_operational_api) {
  RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init(CALLER_LAST);
  Type_assign(&_RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_operational_api, p_c_operational_api, sizeof(union Option_E142FF));
}
...
B RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge__ne(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge this, RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge other);
B RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge__inequiv(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge this, RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge other);
...
void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_string_(STACK_FRAME String result, RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge this) {
  DeclNewStackFrame(caller, "OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge.scala", "RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge", "string", 0);
  String_string_(SF result, string("OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge("));
  String sep = string(", ");
...
void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_cprint(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge this, B isOut) {
  ...
  void *sf = NULL;
  String_cprint(string("OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge("), isOut);
  String sep = string(", ");
...
B RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge__is(STACK_FRAME void* this);
RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge__as(STACK_FRAME void *this);
...
void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_apply(STACK_FRAME RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge this, art_Art_BridgeId id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_0247A1 dispatchTriggers, art_Port_C0524D channel1, art_Port_C0524D channel2, art_Port_C0524D actuate) {
  DeclNewStackFrame(caller, "OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge.scala", "RTS.Actuation.OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge", "apply", 0);
  this->id = id;
  ...
  Type_assign(&this->actuate, actuate, sizeof(struct art_Port_C0524D));
  {
    ...
    t_1.size = (int8_t) 2;
    IS_820232_up(&t_1, 0, (art_UPort) RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel1_(this));
    IS_820232_up(&t_1, 1, (art_UPort) RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel2_(this));
    STATIC_ASSERT(1 <= MaxIS_820232, "Insufficient maximum for IS[Z, art.UPort] elements.");
    DeclNewIS_820232(t_2);
    t_2.size = (int8_t) 1;
    IS_820232_up(&t_2, 0, (art_UPort) RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_actuate_(this));
  ...
  }
  {
    sfUpdateLoc(34);
    {
      ...
      RTS_Actuation_OrLogic_i_Initialization_Api_apply(SF &t_5, RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_id_(this), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel1_(this)), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel2_(this)), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_actuate_(this)));
      ...
      sfUpdateLoc(41);
      {
        ...
        RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_initialization_api_a(SF (Option_1C3ADA) (&t_6));
      }
  ...
  }
  {
    sfUpdateLoc(45);
    {
      ...
      RTS_Actuation_OrLogic_i_Operational_Api_apply(SF &t_7, RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_id_(this), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel1_(this)), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel2_(this)), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_actuate_(this)));
      ...
      sfUpdateLoc(52);
      {
        ...
        RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_operational_api_a(SF (Option_E142FF) (&t_8));
      }
  ...
  {
    sfUpdateLoc(57);
    DeclNewRTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_EntryPoints(t_9);
    RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_EntryPoints_apply(SF &t_9, RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_id_(this), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel1_(this)), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_channel2_(this)), art_Port_C0524D_id_(RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_actuate_(this)), (Option_0247A1) RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_dispatchTriggers_(this), (RTS_Actuation_OrLogic_i_Initialization_Api) RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_initialization_api_(this), (RTS_Actuation_OrLogic_i_Operational_Api) RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_operational_api_(this));
    Type_assign(&this->entryPoints, (&t_9), sizeof(struct RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_EntryPoints));
  }
}
...
void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init_c_initialization_api(STACK_FRAME_ONLY) {
  ...
  Type_assign(&_RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_initialization_api, (&t_0), sizeof(struct None_1FE67C));
};
...
void RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_init_c_operational_api(STACK_FRAME_ONLY) {
  ...
  Type_assign(&_RTS_Actuation_OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge_c_operational_api, (&t_1), sizeof(struct None_1AA45D));
};
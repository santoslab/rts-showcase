...
Unit RTS_Actuation_Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_initialise(STACK_FRAME RTS_Actuation_Actuator_i_Initialization_Api api) {
  DeclNewStackFrame(caller, "Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.scala", "RTS.Actuation.Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator", "initialise", 0);
...
Unit RTS_Actuation_Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_finalise(STACK_FRAME RTS_Actuation_Actuator_i_Operational_Api api) {
  DeclNewStackFrame(caller, "Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator.scala", "RTS.Actuation.Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator", "finalise", 0);
}
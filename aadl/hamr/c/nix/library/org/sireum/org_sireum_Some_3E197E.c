...
B Some_3E197E__equiv(Some_3E197E this, Some_3E197E other) {
  if (art_UPort__inequiv((art_UPort) &this->value, (art_UPort) &other->value)) return F;
  return T;
}

B Some_3E197E__ne(Some_3E197E this, Some_3E197E other);
B Some_3E197E__inequiv(Some_3E197E this, Some_3E197E other);

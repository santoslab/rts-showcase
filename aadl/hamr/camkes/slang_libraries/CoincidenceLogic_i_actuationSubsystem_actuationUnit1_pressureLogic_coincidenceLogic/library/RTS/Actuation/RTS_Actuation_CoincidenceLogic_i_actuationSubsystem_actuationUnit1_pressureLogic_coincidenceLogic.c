...
Unit RTS_Actuation_CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_initialise(STACK_FRAME RTS_Actuation_CoincidenceLogic_i_Initialization_Api api) {
  DeclNewStackFrame(caller, "CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.scala", "RTS.Actuation.CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic", "initialise", 0);
...
Unit RTS_Actuation_CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_finalise(STACK_FRAME RTS_Actuation_CoincidenceLogic_i_Operational_Api api) {
  DeclNewStackFrame(caller, "CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic.scala", "RTS.Actuation.CoincidenceLogic_i_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic", "finalise", 0);
}
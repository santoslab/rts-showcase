...
B art_DispatchPropertyProtocol_Periodic__equiv(art_DispatchPropertyProtocol_Periodic this, art_DispatchPropertyProtocol_Periodic other);
inline B art_DispatchPropertyProtocol_Periodic__inequiv(art_DispatchPropertyProtocol_Periodic this, art_DispatchPropertyProtocol_Periodic other) {
  return !art_DispatchPropertyProtocol_Periodic__equiv(this, other);
};

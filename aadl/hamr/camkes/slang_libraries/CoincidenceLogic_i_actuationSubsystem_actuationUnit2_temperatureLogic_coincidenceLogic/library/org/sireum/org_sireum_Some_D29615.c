...
B Some_D29615__equiv(Some_D29615 this, Some_D29615 other) {
  if (art_DataContent__inequiv((art_DataContent) &this->value, (art_DataContent) &other->value)) return F;
  return T;
}

B Some_D29615__ne(Some_D29615 this, Some_D29615 other);
B Some_D29615__inequiv(Some_D29615 this, Some_D29615 other);

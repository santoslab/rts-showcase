...
B RTS_Base_Types_Integer_64_Payload__ne(RTS_Base_Types_Integer_64_Payload this, RTS_Base_Types_Integer_64_Payload other);
B RTS_Base_Types_Integer_64_Payload__inequiv(RTS_Base_Types_Integer_64_Payload this, RTS_Base_Types_Integer_64_Payload other);

void RTS_Base_Types_Integer_64_Payload_string_(STACK_FRAME String result, RTS_Base_Types_Integer_64_Payload this) {
  DeclNewStackFrame(caller, "Base_Types.scala", "RTS.Base_Types.Integer_64_Payload", "string", 0);
...
B RTS_Base_Types_Integer_64_Payload__is(STACK_FRAME void* this);
RTS_Base_Types_Integer_64_Payload RTS_Base_Types_Integer_64_Payload__as(STACK_FRAME void *this);

void RTS_Base_Types_Integer_64_Payload_apply(STACK_FRAME RTS_Base_Types_Integer_64_Payload this, S64 value) {
  DeclNewStackFrame(caller, "Base_Types.scala", "RTS.Base_Types.Integer_64_Payload", "apply", 0);
  this->value = value;
}
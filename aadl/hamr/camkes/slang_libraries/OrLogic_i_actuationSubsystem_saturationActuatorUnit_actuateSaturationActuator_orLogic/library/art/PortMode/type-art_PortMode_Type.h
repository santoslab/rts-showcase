...
inline B art_PortMode_Type__equiv(art_PortMode_Type this, art_PortMode_Type other) {
  return this == other;
}

inline B art_PortMode_Type__inequiv(art_PortMode_Type this, art_PortMode_Type other) {
  return this != other;
}

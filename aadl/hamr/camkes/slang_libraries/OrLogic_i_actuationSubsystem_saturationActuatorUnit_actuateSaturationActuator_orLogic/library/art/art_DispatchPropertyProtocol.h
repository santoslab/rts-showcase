...
#define art_DispatchPropertyProtocol__equiv(this, other) Type__equiv(this, other)
#define art_DispatchPropertyProtocol__inequiv(this, other) (!Type__equiv(this, other))

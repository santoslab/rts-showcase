...
B RTS_Actuation_OrLogic_i_Initialization_Api__ne(RTS_Actuation_OrLogic_i_Initialization_Api this, RTS_Actuation_OrLogic_i_Initialization_Api other);
B RTS_Actuation_OrLogic_i_Initialization_Api__inequiv(RTS_Actuation_OrLogic_i_Initialization_Api this, RTS_Actuation_OrLogic_i_Initialization_Api other);
...
void RTS_Actuation_OrLogic_i_Initialization_Api_string_(STACK_FRAME String result, RTS_Actuation_OrLogic_i_Initialization_Api this) {
  DeclNewStackFrame(caller, "OrLogic_i_Api.scala", "RTS.Actuation.OrLogic_i_Initialization_Api", "string", 0);
  String_string_(SF result, string("OrLogic_i_Initialization_Api("));
  String sep = string(", ");
...
void RTS_Actuation_OrLogic_i_Initialization_Api_cprint(RTS_Actuation_OrLogic_i_Initialization_Api this, B isOut) {
  ...
  void *sf = NULL;
  String_cprint(string("OrLogic_i_Initialization_Api("), isOut);
  String sep = string(", ");
...
B RTS_Actuation_OrLogic_i_Initialization_Api__is(STACK_FRAME void* this);
RTS_Actuation_OrLogic_i_Initialization_Api RTS_Actuation_OrLogic_i_Initialization_Api__as(STACK_FRAME void *this);
...
void RTS_Actuation_OrLogic_i_Initialization_Api_apply(STACK_FRAME RTS_Actuation_OrLogic_i_Initialization_Api this, art_Art_BridgeId id, art_Art_PortId channel1_Id, art_Art_PortId channel2_Id, art_Art_PortId actuate_Id) {
  DeclNewStackFrame(caller, "OrLogic_i_Api.scala", "RTS.Actuation.OrLogic_i_Initialization_Api", "apply", 0);
  this->id = id;

#ifndef SIREUM_H_RTS_Actuation_OrLogic_i_Api
#define SIREUM_H_RTS_Actuation_OrLogic_i_Api
...
// RTS.Actuation.OrLogic_i_Api

#define RTS_Actuation_OrLogic_i_Api__eq(this, other) Type__eq(this, other)
#define RTS_Actuation_OrLogic_i_Api__ne(this, other) (!Type__eq(this, other))
#define RTS_Actuation_OrLogic_i_Api__equiv(this, other) Type__equiv(this, other)
#define RTS_Actuation_OrLogic_i_Api__inequiv(this, other) (!Type__equiv(this, other))
#define RTS_Actuation_OrLogic_i_Api_cprint(this, isOut) Type_cprint(this, isOut)
B RTS_Actuation_OrLogic_i_Api__is(STACK_FRAME void *this);
RTS_Actuation_OrLogic_i_Api RTS_Actuation_OrLogic_i_Api__as(STACK_FRAME void *this);
inline void RTS_Actuation_OrLogic_i_Api_string_(STACK_FRAME String result, RTS_Actuation_OrLogic_i_Api this) {

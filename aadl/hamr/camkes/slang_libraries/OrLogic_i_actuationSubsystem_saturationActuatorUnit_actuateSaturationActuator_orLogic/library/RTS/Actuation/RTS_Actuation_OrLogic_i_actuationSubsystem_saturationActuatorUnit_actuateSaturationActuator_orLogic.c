...
Unit RTS_Actuation_OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_initialise(STACK_FRAME RTS_Actuation_OrLogic_i_Initialization_Api api) {
  DeclNewStackFrame(caller, "OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic.scala", "RTS.Actuation.OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic", "initialise", 0);
...
Unit RTS_Actuation_OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_finalise(STACK_FRAME RTS_Actuation_OrLogic_i_Operational_Api api) {
  DeclNewStackFrame(caller, "OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic.scala", "RTS.Actuation.OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic", "finalise", 0);
}
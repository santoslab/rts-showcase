...
B B__eq(B b1, B b2);
B B__ne(B b1, B b2);
B B__equiv(B b1, B b2);
B B__inequiv(B b1, B b2);
B B__complement(B b);
B B__and(B b1, B b2);
B B__or(B b1, B b2);
B B__xor(B b1, B b2);
...
B C__eq(C c1, C c2);
B C__ne(C c1, C c2);
B C__equiv(C c1, C c2);
B C__inequiv(C c1, C c2);
B C__lt(C c1, C c2);
B C__le(C c1, C c2);
B C__gt(C c1, C c2);
B C__ge(C c1, C c2);
...
B Z__eq(Z n1, Z n2);
B Z__ne(Z n1, Z n2);
B Z__equiv(Z n1, Z n2);
B Z__inequiv(Z n1, Z n2);
B Z__lt(Z n1, Z n2);
B Z__le(Z n1, Z n2);
B Z__gt(Z n1, Z n2);
B Z__ge(Z n1, Z n2);
...
B F32__fpeq(F32 n1, F32 n2);
B F32__fpne(F32 n1, F32 n2);
B F32__equiv(F32 n1, F32 n2);
B F32__inequiv(F32 n1, F32 n2);
...
B F64__fpeq(F64 n1, F64 n2);
B F64__fpne(F64 n1, F64 n2);
B F64__equiv(F64 n1, F64 n2);
B F64__inequiv(F64 n1, F64 n2);
...
B R__eq(R n1, R n2);
B R__ne(R n1, R n2);
B R__equiv(R n1, R n2);
B R__inequiv(R n1, R n2);
B R__lt(R n1, R n2);
B R__le(R n1, R n2);
B R__gt(R n1, R n2);
B R__ge(R n1, R n2);
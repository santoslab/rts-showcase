...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "SlangTypeLibrary.scala", "RTS.SlangTypeLibrary.SlangTypeLibrary", "<App>", 0);
  ...
  return (int) RTS_SlangTypeLibrary_SlangTypeLibrary_main(SF &t_args);
}
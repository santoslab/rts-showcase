...
B art_Bridge_Ports__equiv(art_Bridge_Ports this, art_Bridge_Ports other) {
  if (IS_820232__inequiv((IS_820232) &this->dataIns, (IS_820232) &other->dataIns)) return F;
  if (IS_820232__inequiv((IS_820232) &this->dataOuts, (IS_820232) &other->dataOuts)) return F;
  if (IS_820232__inequiv((IS_820232) &this->eventIns, (IS_820232) &other->eventIns)) return F;
  if (IS_820232__inequiv((IS_820232) &this->eventOuts, (IS_820232) &other->eventOuts)) return F;
  return T;
}

B art_Bridge_Ports__ne(art_Bridge_Ports this, art_Bridge_Ports other);
B art_Bridge_Ports__inequiv(art_Bridge_Ports this, art_Bridge_Ports other);
...
void art_Bridge_Ports_apply(STACK_FRAME art_Bridge_Ports this, IS_820232 dataIns, IS_820232 dataOuts, IS_820232 eventIns, IS_820232 eventOuts) {

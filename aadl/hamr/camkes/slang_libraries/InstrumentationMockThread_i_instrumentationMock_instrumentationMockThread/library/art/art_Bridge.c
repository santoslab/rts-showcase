...
B art_Bridge__is(STACK_FRAME void *this) {
  switch(((Type) this)->type) {
    case TRTS_Instrumentation_InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_Bridge: return T;
    default: return F;
  }
}
...
art_Bridge art_Bridge__as(STACK_FRAME void *this) {
  switch(((Type) this)->type) {
    case TRTS_Instrumentation_InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_Bridge: break;
    default:

...
#define RTS_Actuation_CoincidenceLogic_i_Api__eq(this, other) Type__eq(this, other)
#define RTS_Actuation_CoincidenceLogic_i_Api__ne(this, other) (!Type__eq(this, other))
#define RTS_Actuation_CoincidenceLogic_i_Api__equiv(this, other) Type__equiv(this, other)
#define RTS_Actuation_CoincidenceLogic_i_Api__inequiv(this, other) (!Type__equiv(this, other))
#define RTS_Actuation_CoincidenceLogic_i_Api_cprint(this, isOut) Type_cprint(this, isOut)
...
inline void RTS_Actuation_CoincidenceLogic_i_Api_string_(STACK_FRAME String result, RTS_Actuation_CoincidenceLogic_i_Api this) {

...
B RTS_EventControl_EventControlMockThread_i_Initialization_Api__ne(RTS_EventControl_EventControlMockThread_i_Initialization_Api this, RTS_EventControl_EventControlMockThread_i_Initialization_Api other);
B RTS_EventControl_EventControlMockThread_i_Initialization_Api__inequiv(RTS_EventControl_EventControlMockThread_i_Initialization_Api this, RTS_EventControl_EventControlMockThread_i_Initialization_Api other);
...
void RTS_EventControl_EventControlMockThread_i_Initialization_Api_string_(STACK_FRAME String result, RTS_EventControl_EventControlMockThread_i_Initialization_Api this) {
  DeclNewStackFrame(caller, "EventControlMockThread_i_Api.scala", "RTS.EventControl.EventControlMockThread_i_Initialization_Api", "string", 0);
  String_string_(SF result, string("EventControlMockThread_i_Initialization_Api("));
  String sep = string(", ");
...
void RTS_EventControl_EventControlMockThread_i_Initialization_Api_cprint(RTS_EventControl_EventControlMockThread_i_Initialization_Api this, B isOut) {
  ...
  void *sf = NULL;
  String_cprint(string("EventControlMockThread_i_Initialization_Api("), isOut);
  String sep = string(", ");
...
B RTS_EventControl_EventControlMockThread_i_Initialization_Api__is(STACK_FRAME void* this);
RTS_EventControl_EventControlMockThread_i_Initialization_Api RTS_EventControl_EventControlMockThread_i_Initialization_Api__as(STACK_FRAME void *this);
...
void RTS_EventControl_EventControlMockThread_i_Initialization_Api_apply(STACK_FRAME RTS_EventControl_EventControlMockThread_i_Initialization_Api this, art_Art_BridgeId id, art_Art_PortId manualActuatorInput1_Id, art_Art_PortId manualActuatorInput2_Id) {
  DeclNewStackFrame(caller, "EventControlMockThread_i_Api.scala", "RTS.EventControl.EventControlMockThread_i_Initialization_Api", "apply", 0);
  this->id = id;

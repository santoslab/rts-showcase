...
B RTS_Base_Types_Float_32_Payload__ne(RTS_Base_Types_Float_32_Payload this, RTS_Base_Types_Float_32_Payload other);
B RTS_Base_Types_Float_32_Payload__inequiv(RTS_Base_Types_Float_32_Payload this, RTS_Base_Types_Float_32_Payload other);

void RTS_Base_Types_Float_32_Payload_string_(STACK_FRAME String result, RTS_Base_Types_Float_32_Payload this) {
  DeclNewStackFrame(caller, "Base_Types.scala", "RTS.Base_Types.Float_32_Payload", "string", 0);
...
B RTS_Base_Types_Float_32_Payload__is(STACK_FRAME void* this);
RTS_Base_Types_Float_32_Payload RTS_Base_Types_Float_32_Payload__as(STACK_FRAME void *this);

void RTS_Base_Types_Float_32_Payload_apply(STACK_FRAME RTS_Base_Types_Float_32_Payload this, F32 value) {
  DeclNewStackFrame(caller, "Base_Types.scala", "RTS.Base_Types.Float_32_Payload", "apply", 0);
  this->value = value;
}
...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "actuatorsMockThread.scala", "RTS.ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread.actuatorsMockThread", "<App>", 0);
  ...
  return (int) RTS_ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_actuatorsMockThread_main(SF &t_args);
}
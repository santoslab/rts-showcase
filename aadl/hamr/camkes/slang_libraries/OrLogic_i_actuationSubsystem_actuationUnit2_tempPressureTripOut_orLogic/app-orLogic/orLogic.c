...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "orLogic.scala", "RTS.OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic.orLogic", "<App>", 0);
  ...
  return (int) RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_main(SF &t_args);
}
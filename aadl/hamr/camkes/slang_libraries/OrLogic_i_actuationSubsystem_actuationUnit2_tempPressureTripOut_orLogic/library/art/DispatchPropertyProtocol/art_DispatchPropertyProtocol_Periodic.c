...
B art_DispatchPropertyProtocol_Periodic__equiv(art_DispatchPropertyProtocol_Periodic this, art_DispatchPropertyProtocol_Periodic other) {
  if (Z__inequiv(this->period, other->period)) return F;
  return T;
}
...
B art_DispatchPropertyProtocol_Periodic__inequiv(art_DispatchPropertyProtocol_Periodic this, art_DispatchPropertyProtocol_Periodic other);

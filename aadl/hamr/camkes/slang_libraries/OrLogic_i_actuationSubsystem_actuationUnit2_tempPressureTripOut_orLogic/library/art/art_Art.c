...
Unit art_Art_logInfo(STACK_FRAME art_Art_BridgeId bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(101);
    {
      ...
      RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_logInfo(SF (String) ((String) &t_5), (String) msg);
    }
  } else {

    sfUpdateLoc(103);
    {
      RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_logInfo(SF (String) string(""), (String) msg);
    }
  }
}
...
Unit art_Art_logDebug(STACK_FRAME art_Art_BridgeId bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(117);
    {
      ...
      DeclNewString(t_5);
      art_Bridge_name_(SF (String) &t_5, ((art_Bridge) &t_4));
      RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_logDebug(SF (String) ((String) &t_5), (String) msg);
    }
  } else {

    sfUpdateLoc(119);
    {
      RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_logDebug(SF (String) string(""), (String) msg);
    }
  }
}
...
Unit art_Art_logError(STACK_FRAME art_Art_BridgeId bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(109);
    {
      ...
      DeclNewString(t_5);
      art_Bridge_name_(SF (String) &t_5, ((art_Bridge) &t_4));
      RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_logError(SF (String) ((String) &t_5), (String) msg);
    }
  } else {

    sfUpdateLoc(111);
    {
      RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_logError(SF (String) string(""), (String) msg);
    }
  }
}
...
void art_Art_getValue(STACK_FRAME Option_8E9F45 result, art_Art_PortId portId) {
  ...
  RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_getValue(SF (Option_8E9F45) &t_0, portId);
...
Unit art_Art_putValue(STACK_FRAME art_Art_PortId portId, art_DataContent data) {
  ...
  sfUpdateLoc(84);
  {
    RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_putValue(SF portId, (art_DataContent) data);
  }
}
...
Unit art_Art_sendOutput(STACK_FRAME IS_D10119 eventPortIds, IS_D10119 dataPortIds) {
  ...
  sfUpdateLoc(92);
  {
    RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_sendOutput(SF (IS_D10119) eventPortIds, (IS_D10119) dataPortIds);
  }
}
...
Unit art_Art_receiveInput(STACK_FRAME IS_D10119 eventPortIds, IS_D10119 dataPortIds) {
  ...
  sfUpdateLoc(80);
  {
    RTS_OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_orLogic_seL4App_receiveInput(SF (IS_D10119) eventPortIds, (IS_D10119) dataPortIds);
  }
}

...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "actuator.scala", "RTS.Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator.actuator", "<App>", 0);
  ...
  return (int) RTS_Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_actuator_main(SF &t_args);
}
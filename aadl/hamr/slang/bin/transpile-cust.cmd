  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--sequence", s"MS[Z,Option[art.Bridge]]=15;IS[Z,String]=3;IS[Z,art.Art.PortId]=24;IS[Z,art.UPort]=24;IS[Z,(B,B)]=9;ISZ[((B,B,B,B,B,B,B,B,B,B,B,B),(B,B,B,B,B,B,B,B,B,B,B,B))]=9",
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--sequence", s"MS[Z,Option[art.Bridge]]=15;IS[Z,String]=3;IS[Z,art.Art.PortId]=24;IS[Z,art.UPort]=24;IS[Z,(Z,art.ArtSlangMessage)]=92;IS[Z,art.Art.BridgeId]=15;IS[Z,art.scheduling.static.Schedule.Slot]=15;IS[Z,(String,art.Art.BridgeId)]=15;IS[Z,(B,B)]=9;ISZ[((B,B,B,B,B,B,B,B,B,B,B,B),(B,B,B,B,B,B,B,B,B,B,B,B))]=9",

...
@sig trait OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_PreState_Container extends Container {
  def api_channel1: B
  def api_channel2: B
}
...
@sig trait OrLogic_i_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_PostState_Container extends Container {
  def api_actuate: B
}

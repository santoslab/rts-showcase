...
@msig trait Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_P_Trait extends Profile {
  ...
  def update_api_input(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_P_Trait
  def update_api_manualActuatorInput(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_P_Trait
}
...
@record class Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_P(
  ...
  override def update_api_input(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_P_Trait = {
    return this(api_input = v)
  }

  override def update_api_manualActuatorInput(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_P_Trait = {
...
@msig trait Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_PS_Trait extends Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_P_Trait {
  ...
  def update_api_input(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_PS_Trait
  def update_api_manualActuatorInput(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_PS_Trait
}
...
@record class Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_PS(
  ...
  override def update_api_input(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_PS_Trait = {
    return this(api_input = v)
  }

  override def update_api_manualActuatorInput(v: RandomLib): Actuator_i_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Profile_PS_Trait = {
    return this(api_manualActuatorInput = v)
  }
}

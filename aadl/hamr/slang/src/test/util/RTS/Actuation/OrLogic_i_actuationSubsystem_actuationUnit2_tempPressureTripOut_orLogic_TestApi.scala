...
@msig trait OrLogic_i_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_TestApi {
  ...
  def get_actuate_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.RTS_i_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic.initialization_api.actuate_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }

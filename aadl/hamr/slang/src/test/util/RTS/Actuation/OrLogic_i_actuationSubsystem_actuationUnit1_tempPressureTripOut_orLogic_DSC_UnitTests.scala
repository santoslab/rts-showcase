...
object OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_DSC_UnitTests()
    /*
    val c = instance.next()
...
class OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_DSC_UnitTests extends OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_GumboX_UnitTests
